...
Active slices correspond to slices in state StableOK or StableError.
Possible slice states: Nascent, Configuring, StableError, StableOK, Closing, Dead, Modifying, ModifyOK, ModifyError, AllocatedError, AllocatedOK.
Possible sliver types: VM, Switch, Facility, L2STS, L2PTP, L2Bridge, FABNetv4, FABNetv6, PortMirror, L3VPN, FABNetv4Ext, FABNetv6Ext
Possible sliver states: Nascent, Ticketed, Active, ActiveTicketed, Closed, CloseWait, Failed, Unknown, CloseFail
Possible component types: GPU, SmartNIC, SharedNIC, FPGA, NVME, Storage
