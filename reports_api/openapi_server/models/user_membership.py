...
from reports_api.openapi_server.models.user_membership_projects_inner import UserMembershipProjectsInner  # noqa: E501
...
class UserMembership(Model):
    ...
    def __init__(self, user_id=None, user_email=None, active=None, user_name=None, affiliation=None, registered_on=None, last_updated=None, google_scholar=None, scopus=None, projects=None):  # noqa: E501
        ...
        :type projects: List[UserMembershipProjectsInner]
        """
        self.openapi_types = {
            'user_id': str,
            'user_email': str,
            ...
            'google_scholar': str,
            'scopus': str,
            'projects': List[UserMembershipProjectsInner]
        }
    ...
    @property
    def projects(self) -> List[UserMembershipProjectsInner]:
        ...
        :rtype: List[UserMembershipProjectsInner]
        """
        return self._projects

    @projects.setter
    def projects(self, projects: List[UserMembershipProjectsInner]):
