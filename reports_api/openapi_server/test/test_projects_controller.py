...
from reports_api.openapi_server.models.project_memberships import ProjectMemberships  # noqa: E501
...
class TestProjectsController(BaseTestCase):
    ...
    def test_projects_memberships_get(self):
        ...
        response = self.client.open(
            '/RENCI3/analytics/1.0.0/projects/memberships',
            method='GET',
            headers=headers,
            query_string=query_string)
        self.assert200(response,
    ...
    def test_projects_uuid_get(self):
        ...
        response = self.client.open(
            '/RENCI3/analytics/1.0.0/projects/{uuid}'.format(uuid='uuid_example'),
            method='GET',
            headers=headers)
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
